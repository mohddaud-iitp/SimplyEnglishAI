...
const Slideshow = () => {
  return (
    <div className='py-12 flex flex-col px-40 '>
      ...
      <div className='flex flex-row  pl-20 pr-6 justify-center relative'> 
      <img src= {Guideprompts} alt="..."  className='h-[200%] w-[325px] pl-8 relative z-[5] '/>
      <div className='flex flex-col justify-center pl-56 z-[5] relative'>  
      ...
      <div className='flex flex-row  pl-20 pr-6 justify-center relative'> 
      <img src= {voice} alt="..."  className='h-[200%] w-[325px] pl-8 relative z-[5] '/>
      <div className='flex flex-col justify-center pl-52 z-[5] relative'>  
      ...
      <div className='flex flex-row  pl-20 pr-6 justify-center relative'> 
      <img src= {voiceenabled} alt="..."  className='h-[200%] w-[325px] pl-8 relative z-[5] '/>
      <div className='flex flex-col justify-center pl-52 z-[5] relative'>  
      ...
      <div className='flex flex-row  pl-20 pr-6 justify-center relative'> 
      <img src= {chathistory} alt="..."  className='h-[200%] w-[325px] pl-8 relative z-[5] '/>
      <div className='flex flex-col justify-center pl-52 z-[5] relative'>  
      ...
      <div className='flex flex-row  pl-20 pr-6 justify-center relative'> 
      <img src= {askanything} alt="..."  className='h-[200%] w-[325px] pl-8 relative z-[5] '/>
      <div className='flex flex-col justify-center pl-52 z-[5] relative'>  
